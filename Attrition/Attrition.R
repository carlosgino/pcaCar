...
#Calculate the average log time in the office

#Read the In_time and Out_time datasets

in_time<-read.csv('https://raw.githubusercontent.com/ashwinbaldawa/Employee-Attrition-Prediction/master/in_time.csv',
                  stringsAsFactors = FALSE)
str(in_time)

out_time<-read.csv('https://raw.githubusercontent.com/ashwinbaldawa/Employee-Attrition-Prediction/master/out_time.csv',
                   stringsAsFactors = FALSE)
str(out_time)
...
General_Data<-read.csv('https://raw.githubusercontent.com/ashwinbaldawa/Employee-Attrition-Prediction/master/general_data.csv',
                       stringsAsFactors = FALSE)
...
Empl_Surv_Data<-read.csv('https://raw.githubusercontent.com/ashwinbaldawa/Employee-Attrition-Prediction/master/employee_survey_data.csv',
                         stringsAsFactors = FALSE)
...
Mana_Surv_Data<-read.csv('https://raw.githubusercontent.com/ashwinbaldawa/Employee-Attrition-Prediction/master/manager_survey_data.csv',
                         stringsAsFactors = FALSE)
